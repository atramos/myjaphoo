...
public class FileVal extends StringVal implements EditableFileVal{

  public FileVal(AbstractMetadata parent, String name, String guiName, String description, String defaultVal) {
