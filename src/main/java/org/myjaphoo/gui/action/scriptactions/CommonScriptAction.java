 ...
 * @version $Id$
 */
public class CommonScriptAction extends AbstractWankmanAction {

    private ActionEntry actionEntry;

    public CommonScriptAction(MyjaphooController controller, ViewContext context, ActionEntry actionEntry) {
