 ...
 * @author lang
 */
public class AddCoverFrontPicture extends AbstractWankmanAction implements DisplayAsLastUsedActions {
    ...
    public AddCoverFrontPicture(MyjaphooController controller, ViewContext context) {
    ...
    public void run(final MyjaphooController controller, ActionEvent e, ViewContext context) throws Exception {
        ...
        File file = super.chooseFile("Select the cover front picture file");

        controller.addCoverFrontPicture(file, entry);
