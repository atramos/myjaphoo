 ...
 * @author lang
 */
public class DesktopOpenAction extends AbstractWankmanAction implements DisplayAsLastUsedActions {
    ...
    public DesktopOpenAction(MyjaphooController controller, ViewContext context) {
        super(controller, localeBundle.getString("DesktopOpenAction.OPEN FILE"), null, context);
    }
